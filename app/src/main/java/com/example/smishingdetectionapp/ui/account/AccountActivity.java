...
import com.example.smishingdetectionapp.UserProfileActivity; // <-- FIXED import
...
public class AccountActivity extends SharedActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Remove explicit types in lambda to avoid View import issue
        ...
        // NEW: View Profile button (make sure activity_account.xml has @+id/viewProfileBtn)
