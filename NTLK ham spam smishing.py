...
# Automatically select and rename the first 5 columns (adjust if more columns exist)
df_train = df_train.iloc[:, :5]  # Select first 5 columns
...
df_new = pd.read_csv('Merged_Dataset.csv', encoding='latin1')  # Change file for data that the user wants to test

# Automatically select and rename the first 5 columns (adjust if more columns exist)
df_new = df_new.iloc[:, :5]  # Select first 5 columns
